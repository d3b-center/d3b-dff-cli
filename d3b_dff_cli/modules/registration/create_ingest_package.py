...
def main(args):
    ...
    # Step 4: Modify the default values in the new package
    ...
    # Only move and remove these specific files
    ...
    # Print message
    line1 = f"To ingest your package, please run `d3b registration run {package_name}`."
    line2 = f"To test your package, please run `kidsfirst test {package_name}`."
